  ...
  <section id="team">
    <div class="container wow fadeInUp">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="member">
            <div class="pic"><img src="fotos/Rai.jpg" alt=""></div>
            <h4>Abiam Rai Tapia Romero</h4>
        ...
        <div class="col-md-3">
          <div class="member">
            <div class="pic"><img src="fotos/Aldair.jpg" alt=""></div>
            <h4>Aldair Rodríguez Ramírez</h4>
            <span>Estudiante Ingenieria</span>
            <div class="social">
        ...
        <div class="col-md-3">
          <div class="member">
            <div class="pic"><img src="fotos/gerardo.jpg" alt=""></div>
        ...
        <div class="col-md-3">
          <div class="member">
            <div class="pic"><img src="fotos/david.jpg" alt=""></div>
            <h4>David Aguirre del Valle</h4>
            <span>Estudiante Ingenieria</span>
            <div class="social">
              <a href=""><i class="fa fa-twitter"></i></a>
  ...
  <footer id="footer">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="copyright">
              &copy; Copyright <strong>Desarrollo de sitios web</strong>. All Rights Reserved
            </div>
            <div class="credits">
              <!-- 
              ...
              -->
              Desarrollo de Sitios web by <a href="https://www.cs.buap.mx/academicos/datos-profes.php?id=100210511">Dr. Mario Anzures García</a>
            </div>
          </div>
        </div>
      </div>
