          ...
          <section id="formulario">
            ...
            <form role="form" name="registro" action="php/registroem.php" method="post">
                     ...
                     <label id="label">Nombre Empresa : 
                         <input type="text" name="nombreE" id="nombreE" placeholder="Nombre de empresa" />         
                     </label>
               <br><br>
               <label id="label">Nombre de jefe de personal :
                     <input type="text" name="nombreJ" id="nombreJ" placeholder="Nombre del jefe" />         
                 </label><br><br>
                 <label id="label">Direccion de la empresa :
                     <input type="text" name="direccione" id="direccione" placeholder="Direccion de la empresa" />         
                 </label><br><br>
               <label id="label"> Teléfono de Contacto :
                      <input type="text" name="telefonoe" id="telefonoe" placeholder="Teléfono" />         
                 </label><br><br>
                 <label id="label">Correo electronico :
                     <input type="text" name="emaile" id="emaile" placeholder="Email" />         
                 </label><br><br>
               <label id="label">Usuario :
                     <input type="text" name="logine" id="logine" placeholder="Usuario empresa" />
                 </label><br><br>
                 <label id="label">Contraseña :
                     <input type="password" name="passe" id="passe" placeholder="Contraseña" />         
                 </label><br>
                <br>
