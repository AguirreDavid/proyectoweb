...
if(isset($insertar)){			
			...
			if ($_FILES['foto']['type'] != "image/jpeg" && $_FILES['foto']['type'] != "image/png"){
				...
				$sql = "insert into cv(nombreCV,edad,sexo,dircv,retribucion_Minima,tipo_Jornada,grado_Estudios,habilidades,fotografia,id_Candidato) values ('$nombreCV','$edad','$sexo', '$direccion','$retribucion','$jornada','$estudio','$extras','$ruta','$id')";
